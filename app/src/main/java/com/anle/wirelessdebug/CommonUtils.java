...
public class CommonUtils {
    ...
    public static String extractFieldFromSystemFile(File file, String fieldname) {
        ...
        if (file.exists()) {
            ...
            try {
                ...
                Log.e("Error parsing " + file, e.getMessage());
            } finally {
    ...
    enum Architecture {
        ...
        static Architecture getValue() {
            ...
            if (TextUtils.isEmpty(arch)) {
                Log.d("CommonUtils","Architecture#getValue()::Build.CPU_ABI returned null or empty");
                return UNKNOWN;
            }
            ...
            if (!TextUtils.isEmpty(result)) {
                ...
                try {
                    if (result.endsWith("KB")) {
                       ...
                       Log.w("CommonUtils","Unexpected meminfo format while computing RAM: " + result);
                    }
                } catch (NumberFormatException e) {
                    Log.e("CommonUtils", "Unexpected meminfo format while computing RAM: " + result + e.getMessage());
                }
            }
    ...
    private static String hash(byte[] bytes, String algorithm) {
        ...
        try {
            ...
            Log.e
                    ("CommonUtils","Could not create hashing algorithm: " + algorithm + ", returning empty string.", e);
            return "";
        }
    ...
    public static String resolveUnityEditorVersion(Context context) {
        ...
        if (id != 0) {
            ...
            Log.i("CommonUtils","Unity Editor version is: " + version);
        }
        return version;
    }
